...
const extraScriptConfig = {
	...baseConfig,
	// Extra scripts run inside webviews (browser context), not in the plugin's
	// node sandbox. Override the base target and explicitly include the 'import'
	// condition so ESM-only packages (e.g. json-canvas-viewer) resolve.
	target: 'web',
	resolve: {
		alias: {
			api: path.resolve(__dirname, 'api'),
